...
sys.path.append(os.path.join(os.path.dirname(__file__), "../../generation/chat-brain"))
...
DEFAULT_DATA = os.path.join(os.path.dirname(__file__), "../../generation/chat-brain/data/chat_context.tsv")
DEFAULT_TYPER_CKPT = os.path.join(os.path.dirname(__file__), "../../generation/chat-brain/model/chat_typer.pt")
DEFAULT_FAST_CKPT = os.path.join(os.path.dirname(__file__), "../../generation/chat-brain/model/fast_reader.pt")
DEFAULT_SEMANTIC_INIT = os.path.join(os.path.dirname(__file__), "../../generation/chat-brain/model/noun_collapse_pure.pt")
