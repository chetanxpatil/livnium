...
experimental `research/nli/supervised-collapse/` line. Given two sentences — a **premise** and a
...
Produced by `research/nli/supervised-collapse/train_collapse_embeddings.py --task nli`. Reproduce
