...
def main():
    ...
    noun_default = os.path.join(here, "..", "..", "models", "noun-collapse", "model",
                                "noun_collapse_pure.pt")
    chat_default = os.path.join(here, "..", "chat-brain", "model", "chat_reply_general.pt")
    ap.add_argument("--noun", default=noun_default)
