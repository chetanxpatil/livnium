...
NLI_CKPT = "/Users/chetanpatil/Desktop/lets_clean_it/livnium/research/nli/supervised-collapse/model_nli_v1/nli_epoch20.pt"
SEED = 0
DIM = 256                 # bigger space so word endpoints spread (sentence level needs room)
...
def main():
    ...
    try:
        ...
        ax.set_title(f"Pure CharCollapse — the whole model: 27 learned wells ({DIM}d → 2D)",
