# research/generation/chat-brain/ — the chat-brain + the SNLI premise demo
...
warping the flow-field plots in `docs/collapse/COLLAPSE_VISUALIZATION.md` show) — a linear
