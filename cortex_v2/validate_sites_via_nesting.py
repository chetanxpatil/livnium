...
Two different meanings of 'site', measured together so the answer is unambiguous:
  ...
  AMPLITUDE-LIKE sites  = faithful entangled qubits in an MPS register.
...
print()
print("=" * 80)
print("AMPLITUDE-LIKE sites: faithful entangled qubits in a cube-driven MPS (max_chi=64)")
print("=" * 80)
...
print(f"\n  => deepest FAITHFUL amplitude-like register at chi=64:  {last_ok} sites")

print()
print("ANSWER:")
print(f"  * As ADDRESS sites (nesting): effectively unlimited — e.g. depth 10 = "
      f"{M**30:.2e} sites, conserved, cheap.")
print(f"  * As AMPLITUDE-LIKE sites (entangled): only ~{last_ok} faithful at chi=64; "
